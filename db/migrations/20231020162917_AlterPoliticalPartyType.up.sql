...
CREATE TYPE political_party AS ENUM ('democratic','republican','libertarian','green','constitution','unknown','independent','freedom','unity','approval_voting','unaffiliated','democratic_farmer_labor','grassroots_legalize_cannabis','legal_marijuana_now','socialist_workers','colorado_center','american_constitution');
