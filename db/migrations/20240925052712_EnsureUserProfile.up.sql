...
-- Create a trigger that calls the function whenever a 
...
-- Add a foreign key constraint to ensure that 
...
-- Add a unique constraint to ensure that each user_id in user_profile is unique
ALTER TABLE user_profile
