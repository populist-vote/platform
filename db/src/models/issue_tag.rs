...
impl IssueTag {
    ...
    pub async fn organizations(
        ...
        let records = sqlx::query_as!(
            Organization,
            r#"
                SELECT o.id, slug, name, description, thumbnail_image_url, website_url, facebook_url, twitter_url, instagram_url, email, headquarters_phone, votesmart_sig_id, headquarters_address_id, tax_classification, politician_id, o.assets, o.created_at, o.updated_at  FROM organization o
