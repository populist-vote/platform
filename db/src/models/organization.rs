    ...
    pub async fn create(
        ...
        let record = sqlx::query_as!(
            ...
            r#"
                ...
                RETURNING
                    id, slug, name, description, thumbnail_image_url, website_url, facebook_url, twitter_url, instagram_url, email, votesmart_sig_id, headquarters_address_id, headquarters_phone, tax_classification, politician_id, is_paid, assets, attributes, created_at, updated_at
            "#,
            id,
            slug,
            input.name,
